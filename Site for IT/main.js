...
styles(21, "#3a2496");
styles(22, "#492dc0");
// container1_texts[0].addEventListener("mouseover", function() {
//     body.style.backgroundColor = "D5E9DC"
// })

// Object.values(container1_texts).forEach((elem) => {
//   elem.addEventListener("mouseover", function (event) {
//     body.style.backgroundColor = "#A87E85";
//   });
